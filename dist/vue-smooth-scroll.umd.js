...
function checkNumber() {
  ...
  value = +value;
  return Object(lodash["isNaN"])(value) ? defValue : value;
}
/**
 * @param {Number} limitY
...
function checkLoadCapability() {
  var limitY = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var offsetY = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var loadThreshold = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
...
function getScrollState(scrollBar) {
  ...
  var state = Object(lodash["get"])(scrollBar, prop, {});

  switch (axis) {
    case "x":
    case "y":
      return Object(lodash["get"])(state, axis);
...
/* harmony default export */ var helpers = ({
  ...
  checkLoadCapability: checkLoadCapability,
...
/* harmony default export */ var ScrollViewvue_type_script_lang_js_ = ({
  ...
  computed: {
    hasPlugins: function hasPlugins() {
      if (helpers.isArray(this.plugins)) {
  ...
  methods: {
    ...
    getLimit: function getLimit() {
      ...
      return helpers.getScrollState(this.scrollBar, axis, 'limit');
    },
    ...
    getOffset: function getOffset() {
      var axis = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      return helpers.getScrollState(this.scrollBar, axis, 'offset');
    },
    ...
    removeListener: function removeListener(listener) {
      ...
      this.listeners = this.listeners.filter(function (attached) {
        if (attached === listener) {
          _this.scrollBar.removeListener(listener);
        }
    ...
    removeAllListeners: function removeAllListeners() {
      ...
      this.listeners.forEach(function (listener) {
        _this2.scrollBar.removeListener(listener);
      });
      this.listeners = [];
    },
     ...
     * Emits loading event
     */
    debounceLoad: helpers.debounce(function () {
      if (this.resolve) {
        this.resolve = false;
        this.loading = true;
        this.emitLoad();
    ...
    setLoaded: function setLoaded() {
      ...
      this.$nextTick(function () {
        var limitY = _this4.getLimit('y');

        var offsetY = _this4.getOffset('y');

        if (helpers.checkLoadCapability(limitY, offsetY, _this4.loadThreshold)) {
          _this4.emitLoad();
        }
      });
    },
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      // Use plugins
      if (_this5.hasPlugins) {
        _this5.plugins.forEach(function (plugin) {
          smooth_scrollbar.use(plugin);
        });
      } // Init
      ...
      _this5.addListener(function (status) {
        ...
        var canLoad = helpers.checkLoadCapability(limit.y, offset.y, _this5.loadThreshold);

        _this5.resolve = canLoad;

        if (!_this5.completed) {
          if (canLoad) {
            _this5.debounceLoad(true);
          }
        } else {
  ...
  render: function render(h) {
    ...
    return h('div', containerData, [h('div', {
